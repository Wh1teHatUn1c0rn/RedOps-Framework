...
obfuscator_path = project_root / "RedOps" / "obfuscator.py"
obfuscator_path.parent.mkdir(parents=True, exist_ok=True)
obfuscator_script = """
import argparse
import base64
import os
...
obfuscator_path.write_text(obfuscator_script)

# Make it executable
obfuscator_path.chmod(0o755)

print(f"[*] Obfuscator created at: {obfuscator_path.resolve()}")