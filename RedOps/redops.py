...
redops_path = Path("RedOps") / "redops.py"
redops_path.parent.mkdir(parents=True, exist_ok=True)

with open(redops_path, "w", encoding="utf-8") as f:
    f.write(fixed_redops_code.strip())

print(redops_path.resolve().as_posix())